...
public class LuckyNumbers {
    ...
    public void fiveLuckyNumbers(){
        System.out.printf("Your five lucky numbers are: %s, %s, %s, %s, %s%n", rand.nextInt(151 )-50, rand.nextInt(151 )-50, rand.nextInt(151 )-50, rand.nextInt(151 )-50,rand.nextInt(151 )-50);
